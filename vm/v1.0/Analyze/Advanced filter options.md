...
excerpt: ""
---
* [Syntax Help / Query Dictionary](doc:advanced-filter-options#section-syntax-help-query-dictionary)
* [Filter Operators](doc:advanced-filter-options#section-filter-operators)
* [The <=> operator](doc:advanced-filter-options#section-the-operator)

# Syntax Help / Query Dictionary
...
[block:callout]
{
  "type": "info",
  "title": "TIP",
  "body": "Combine multiple filter parameters to create more advanced filters."
}
[/block]
# The <=> operator

Use the `<=>` operator to retrieve two sets of values from the same parameter.
[block:callout]
{
  "type": "warning",
  "body": "This operator becomes available only when it is applicable. It is not available for all parameters.",
  "title": "NOTE"
}
[/block]